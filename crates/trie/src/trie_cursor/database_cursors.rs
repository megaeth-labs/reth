    ...
    C: DbCursorRO<tables::AccountsTrie> + Send + Sync,
{
    ...
    fn seek_exact(
        ...
        let seek_exact = {
            ...
            let _walker_seek_exact =
                perf_metrics::metrics::DBRecorder::new(perf_metrics::db::add_at_seek_exact);
    ...
    fn current(&mut self) -> Result<Option<TrieKey>, DatabaseError> {
        let current = {
            #[cfg(feature = "enable_state_root_record")]
            let _at_current =
                perf_metrics::metrics::DBRecorder::new(perf_metrics::db::add_at_current);
    ...
    C: DbDupCursorRO<tables::StoragesTrie> + DbCursorRO<tables::StoragesTrie> + Send + Sync,
{
    ...
    fn seek_exact(
        ...
        let seek_by_key_subkey = {
            #[cfg(feature = "enable_state_root_record")]
            let _seek_by_key_subkey =
                perf_metrics::metrics::DBRecorder::new(perf_metrics::db::add_st_seek_by_subkey);
    ...
    fn current(&mut self) -> Result<Option<TrieKey>, DatabaseError> {
        let current = {
            #[cfg(feature = "enable_state_root_record")]
            let _current = perf_metrics::metrics::DBRecorder::new(perf_metrics::db::add_st_current);
